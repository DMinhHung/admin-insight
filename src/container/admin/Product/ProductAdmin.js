...
const ProductAdmin = () => {
  ...
  return (
    <>
                    ...
                    <tbody>
                      {products.map((product) => (
                        <tr key={product.id}>
                          ...
                          <td>
                            <span className="spanadmin">{product.price}</span>
                          </td>
                          <td>
      ...
      <AddProductModal show={isAddModalOpen} handleClose={handleCloseAddModal} />
      <EditProductModal show={isUpdateModalOpen} handleClose={handleCloseUpdateModal} product={selectedProduct} handleUpdate={handleUpdate} />
    </>
  );
};
